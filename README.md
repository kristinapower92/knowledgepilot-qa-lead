...
- [Матрица продуктовых и технических рисков](risk-matrix.md)
...
- [Pytest-проверки evaluation dataset](tests/test_evaluation_dataset.py)
...
После каждого изменения в ветке `main` тесты автоматически запускаются в GitHub Actions.
